...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        sans: ['Inter', 'Aptos', '"Helvetica Neue"', 'Arial', 'ui-sans-serif', 'system-ui', 'sans-serif'],
        display: ['Poppins', 'Inter', 'Aptos', '"Helvetica Neue"', 'Arial', 'ui-sans-serif', 'system-ui', 'sans-serif'],
      },
      backgroundImage: {
