    ...
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {statCards.map((card, i) => (
          <Link key={i} to={card.link} className="card p-5 hover:shadow-md transition-shadow">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link to="/admin/products" className="text-sm text-primary-600 hover:text-primary-700 flex items-center gap-1">
              ...
              {recentProducts.map(p => (
                <div key={p.id} className="flex items-center justify-between py-2 border-b border-gray-50 last:border-0">
                  ...
                  <div className="text-right">
                    ...
                    <span className={`text-xs px-2 py-0.5 rounded-full ${p.stock === 0 ? 'bg-red-100 text-red-600' : p.stock <= 5 ? 'bg-amber-100 text-amber-600' : 'bg-green-100 text-green-600'}`}>
              ...
              {lowStock.map(p => (
                <div key={p.id} className="flex items-center justify-between py-2 border-b border-gray-50 last:border-0">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Link to={`/admin/products/${p.id}/edit`} className="text-xs text-primary-600 hover:underline">
                      Edit
                    </Link>
                  </div>
                </div>
