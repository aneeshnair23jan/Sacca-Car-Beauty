    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">{categories.length} categor{categories.length !== 1 ? 'ies' : 'y'}</p>
        </div>
                ...
                <tr key={cat.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center justify-end gap-1">
                      ...
                      >
                        <Trash2 className={`w-4 h-4 ${cat.product_count > 0 ? 'opacity-30' : ''}`} />
                      </button>
                    </div>
                  </td>
                </tr>
      ...
      {deleteId && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl p-6 max-w-sm w-full shadow-xl">
            ...
            <p className="text-gray-500 text-sm mb-6">This will permanently delete this category. This action cannot be undone.</p>
            <div className="flex gap-3">
